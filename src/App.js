...
const App = (props) => {
  return (
    <Switch>
      {/* Auth Pages */}
      <Route exact path={`${process.env.PUBLIC_URL}/success`} component={Success}></Route>
      <Route exact path={`${process.env.PUBLIC_URL}/reset`} component={ForgotPassword}></Route>
      ...
      <Route exact path={`${process.env.PUBLIC_URL}/otpVerify`} component={VerifyOtp}></Route>
      <Route exact path={`${process.env.PUBLIC_URL}/change-password`} component={changePassword}></Route>
